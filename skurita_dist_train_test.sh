...
echo "###############################"
#bash tools/dist_train.sh  configs/mva2023_skurita/deformable_detr_twostage_refine_r50_16x2_50e_coco.py $GPU_NUM
...
echo "###############################"
#bash tools/dist_train.sh  configs/mva2023_skurita/deformable_detr_twostage_refine_r50_16x2_50e_coco_finetune.py $GPU_NUM
...
echo "###############################"
"""
CONFIG=configs/mva2023_skurita/deformable_detr_twostage_refine_r50_16x2_50e_coco_sample_hard_negative.py
CHECKPOINT=work_dirs/deformable_detr_twostage_refine_r50_16x2_50e_coco_finetune/latest.pth
NNODES=${NNODES:-1}
...
python -m torch.distributed.launch \
 ...
 hard_neg_example_tools/test_hard_neg_example.py \
    ...
    --hard-negative-file work_dirs/deformable_detr_twostage_refine_r50_16x2_50e_coco/train_coco_hard_negative.json \
...
echo "###############################"
#bash tools/dist_train.sh  configs/mva2023_skurita/deformable_detr_twostage_refine_r50_16x2_50e_coco_hard_negative_training.py $GPU_NUM
...
echo "###############################"
bash tools/dist_test.sh configs/mva2023_skurita/deformable_detr_twostage_refine_r50_16x2_50e_coco_inference.py work_dirs/deformable_detr_twostage_refine_r50_16x2_50e_coco_hard_negative_training/latest.pth \
